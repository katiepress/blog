...
<img src="/post/2021-06-21-the-office-part-i/index.en-us_files/figure-html/unnamed-chunk-16-1.png" width="1152" style="display: block; margin: auto;" />
...
<img src="/post/2021-06-21-the-office-part-i/index.en-us_files/figure-html/unnamed-chunk-17-1.png" width="768" style="display: block; margin: auto;" />
...
<img src="/post/2021-06-21-the-office-part-i/index.en-us_files/figure-html/unnamed-chunk-18-1.png" width="768" style="display: block; margin: auto;" />
...
<img src="/post/2021-06-21-the-office-part-i/index.en-us_files/figure-html/unnamed-chunk-29-1.png" width="768" style="display: block; margin: auto;" />
...
```
## # A tibble: 33 × 4
## # Groups:   total_working_years [33]
##    total_working_years attrition     n pct  
##                  <dbl> <chr>     <int> <chr>
##  1                   0 Yes          15 45.5%
##  2                   1 Yes         119 49.2%
##  3                   2 Yes          27 29.0%
...
##   marital_status attrition     n pct  
##   <chr>          <chr>     <int> <chr>
## 1 Divorced       Yes          99 10.1%
## 2 Married        Yes         252 12.5%
## 3 Single         Yes         360 25.5%
```
...
```
## # A tibble: 13 × 4
## # Groups:   years_with_curr_manager [13]
##    years_with_curr_manager attrition     n pct  
##                      <dbl> <chr>     <int> <chr>
##  1                       0 Yes         255 32.3%
##  2                       1 Yes          33 14.5%
##  3                       2 Yes         150 14.5%
...
```
## # A tibble: 3 × 4
## # Groups:   business_travel [3]
##   business_travel   attrition     n pct  
##   <chr>             <chr>     <int> <chr>
## 1 Non-Travel        Yes          36 8.0% 
## 2 Travel Frequently Yes         207 24.9%
## 3 Travel Rarely     Yes         468 15.0%
```
...
```
## # A tibble: 6 × 4
## # Groups:   education_field [6]
##   education_field  attrition     n pct  
##   <chr>            <chr>     <int> <chr>
## 1 Human Resources  Yes          33 40.7%
## 2 Life Sciences    Yes         303 16.7%
## 3 Marketing        Yes          75 15.7%
## 4 Medical          Yes         225 16.2%
## 5 Other            Yes          30 12.2%
## 6 Technical Degree Yes          45 11.4%
```
...
```
## # A tibble: 7 × 4
## # Groups:   training_times_last_year [7]
##   training_times_last_year attrition     n pct  
##                      <dbl> <chr>     <int> <chr>
## 1                        0 Yes          30 18.5%
## 2                        1 Yes          30 14.1%
## 3                        2 Yes         282 17.2%
...
```
## # A tibble: 5 × 4
## # Groups:   job_satisfaction [5]
##   job_satisfaction attrition     n pct  
##              <dbl> <chr>     <int> <chr>
## 1                1 Yes         197 22.9%
## 2                2 Yes         138 16.4%
## 3                3 Yes         219 16.6%
...
<img src="/post/2021-06-21-the-office-part-i/index.en-us_files/figure-html/unnamed-chunk-44-1.png" width="576" style="display: block; margin: auto;" />
