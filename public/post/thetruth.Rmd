...
![](/post/thetruth_files/thetruth1_screenshot1.png){width=600px height=400px}

In this case it's pretty easy, the html nodes I'm interested in are simply "table" class. 

![](/post/thetruth_files/thetruth1_screenshot2.png){width=600px height=400px}
...
my_theme <- theme(legend.position = "none",
        axis.text = element_text(family = "Agency FB", size = 12, color = "#232928"),
        axis.title.y = element_blank(),
        axis.title.x = element_text(family = "Agency FB", size = 14, vjust = -.5, color= "#232928"),
